...
namespace Lewt.Client.UI
{
    ...
    public class RenderEventArgs : EventArgs
    {
        ...
        public RenderEventArgs( Vector2 drawPosition )
        {
    ...
    public class UIObject
    {
        ...
        protected virtual void OnRender( Vector2 renderPosition = new Vector2() )
        {
        ...
        public void Render( Vector2 parentPosition = new Vector2() )
        {
            if ( IsVisible )
            {
                parentPosition += Position;

                OnRender( parentPosition );
                if ( RenderObject != null )
                    RenderObject( this, new RenderEventArgs( parentPosition ) );

                try
                {
                    foreach ( UIObject child in myChildren )
                        child.Render( parentPosition + myPaddingTopLeft );
                }
                catch ( Exception )
                {
