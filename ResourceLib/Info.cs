...
namespace ResourceLib
{
    ...
    public class InfoObject : InfoValue, IEnumerable<KeyValuePair<String, InfoValue>>
    {
        ...
        public Dictionary<String, InfoValue>.KeyCollection Keys
        {
            get
            {
                return myDict.Keys;
        ...
        public Dictionary<String, InfoValue>.ValueCollection Values
        {
            get
            {
        ...
        public bool ContainsValue( InfoValue val )
        {
            return myDict.ContainsValue( val );
        }
